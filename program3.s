...
ls r3, #7               // r3 = 00000000 = 0: index of the current byte of memory we are referencing while scanning the input string initially 0 (first byte)
addi r1, #1             // r1 = 194+1=195: this is the address we will store the index  
str r1, r3              // data_mem[195] = 0: keeping track of current index by storing it in memory (because we will need all three registers sometimes)
ldi r2, #0              // r2 = 0 'L1:' flag indicating the pattern was recognized within the current byte initially 0 (false)
addi r1, #1             // r1 = 32
str r1, r2              // data_mem[32] = 0
ldi r3, #5              // r3 = 00000101
ls r3, #5               // r3 = 0100000 = 32 (address of 5-bit pattern to recognize)
ldr r0, r3              // r0 = 01010xxx = data_mem[32] (get the byte with pattern stored in bits 7:3)
rs r0, #3               // r0 = 00001010
ldi r3, #3              // r3 = 00000011
ls r3, #6               // r3 = 11000000
addi r3, #3             // r3 = 0100001 = 31 (index of current byte in string [data_mem[idx] bits 7:3])
ldr r2, r3              // r2 = 0 = data_mem[31] = index of current byte in string = 0 initially
ldr r1, r2              // r1 = 0000000 = data_mem[0]
rs r1, #3               // r1 = 00001011 (i.e. 000_(bits 7:3 of input string))
eq r1, r0               // r1 = 0 = (r1 == r0) = (00001011 == 00001010)
ldi r3, #3              // r3 = 00000011
ls r3, #6               // r3 = 11000001 = 193
addi r3, #2             // r3 = 11000011 = 195 (i.e. storage addr for total number of times 5-bit pattern occurs with byte boundaries OFF)
...
ldr r0, r2              // r0 = 01000xxx = data_mem[32] (get the byte with pattern stored in bits 7:3)
...
ldr r2, r3              // r2 = 0 = data_mem[195] = current index // going for bits 6:2
ldr r1, r2              // r1 = 00000000 = data_mem[0]
...
ls r3, #5               // r3 = 10100000 = 32  (5-bit pattern to recognize)
ldr r0, r3              // r0 = 01010000 = data_mem[32] = (5-bit pattern)_000
rs r0, #3               // r0 = 00001010 = 0007:3 = 5-bit pattern
ldi r3, #3              // r3 = 00000011
ls r3, #6               // r3 = 11000000
addi r3, #3             // r3 = 01000001 = 31
ldr r2, r3              // r2 = 0 = data_mem[31] (going for data_mem[idx] bits 5:1), R2 = current index
...
ls r3, #5               // r3 = 00100000 = 32 (address of 5-bit pattern to recognize)
ldr r0, r3              // r0 = 01010000 = data_mem[32]
rs r0, #3               // r0 = 00001010
ldi r3, #3              // r3 = 00000011
ls r3, #6               // r3 = 11000000
addi r3, #3             // r3 = 000111111 = 31
ldr r2, r3              // r2 = 0 = data_mem[31]
ldr r1, r2              // r1 = 01011010 = data_mem[]
...
ls r3, #5               // r3 = 00100000 = 32 (addr of 5-bit pattern to recognize)
ldr r0, r3              // r0 = 00100000 = data_mem[32]
rs r0, #3               // r0 = 00001010 
ldi r3, #3              // r3 = 00000011
ls r3, #6               // r3 = 11000000
addi r3, #3             // r3 = 11000011 = 195
ldr r2, r3              // r2 = 128 = data_mem[195] (going for data_mem[idx] bits 3:0 , data_mem[idx+1] bit 7)
ldr r1, r2              // r1  = 01011010 = data_mem[0] = current byte in the string
...
ldi r3, #3              // r3 = 00000011
ls r3, #3               // r3 = 00011000 = 40
addi r3, #1             // r3 = 00011011 = 45 = OFFSET to NEXT_STEP_5
...
ldr r2, r3              // r2 = 0 = data_mem[195]   (want bit 7 of next byte)
addi r2, #1             // r2 = 1 = index of the next byte in the string
ldr r1, r2              // r1 = data_mem[1] is the next byte in the string
...
ls r3, #5               // r3 = 00100000 = 32 (address of 5-bit pattern to recognize)
ldr r0, r3              // r0 = = 00100000 = data_mem[132] = pattern byte
rs r0, #3               // r0 = 00001010 = 0007:3
ldi r3, #3              // r3 = 00000011
ls r3, #6               // r3 = 11000000
addi r3, #3             // r3 = 11000011 = 195
ldr r2, r3              // r2 = 0 = data_mem[195] (want bits 2:0 || data_mem[idx+1] bits 7:6)
ldr r1, r2              // r1 = 00000000 = data_mem[0]
...
ldi r3, #5              // r3 = 00000101
ls r3, #5               // r3 = 00100000 = 32 (address of 5-bit pattern to recognize)
ldr r0, r3              // r0 = 01010000 = data_mem[32]  (pattern byte)
rs r0, #3               // r0 = 00001010  (0007:3)
ldi r3, #3              // r3 = 00000011
ls r3, #6               // r3 = 11000000
addi r3, #3             // r3 = 11000011 = 195
ldr r2, r3              // r2 = 0 = data_mem[195] 
addi r2, #1             // r2 = 1 (looking into bits 7:6) of the next byte to complete the pattern
...
ls r3, #5               // r3 = 00100000 = 32  (address of pattern byte)
ldr r0, r3              // r0 = 01010000 = data_mem[32]   (pattern byte)
rs r0, #3               // r0 = 00001010      ( 0007:3 )
ldi r3, #3              // r3 = 00000011
ls r3, #6               // r3 = 11000000
addi r3, #3             // r3 = 11000011 = 195  (addr of stored index)
ldr r2, r3              // r2 = 0 = data_mem[195]   (checking curr byte bits 1:0 , next byte bits 7:5 )
ldr r1, r2              // r1 = 01011010 = data_mem[0]   (curr byte)
...
ls r3, #2               // r3 = 00011000 = 41
addi r2, #2             // r3 = 00011010 = 46 (OFFSET to NEXT_STEP_7)
...
ls r3, #6               // r3 = 11000000
addi r3, #3             // r3 = 11000011 = 195 (addr of stored index)
ldr r2, r3              // r2 = 0 = data_mem[195]    (looking at curr byte bit 0 , next byte bits 7:4
ldr r1, r2              // r1 = 01011010 = data_mem[0]       (current byte in the string)
...
ldi r3, #3              // r3 = 00000011
ls r3, #3               // r3 = 00011000 = 44
addi r3, #0             // r3 = 44 = OFFSET to NEXT_STEP_8
...
ls r3, #6               // r3 = 11000000
addi r3, #3             // r3 = 11000011 = 195 (addr of stored index)
ldr r2, r3              // r2 = 0 = data_mem[195]   (checking remaining bits 7:4)
addi r2, #1             // r2 = 1    (addr of next byte)
ldr r1, r2              // r1 = 01011010 = data_mem[1]   (next byte)
...
ls r3, #6               // r3 = 11000000
addi r3, #3             // r3 = 11000011 = 195 (index of current byte in string [data_mem[idx] bits 7:3])
ldr r1, r3              // r1 = 0 = data_mem[195] 
addi r1, #1             // r1 = 1    (increment index of current byte in string)
str r3, r1              // data_mem[195] = 1
ldi r2, #5              // r2 = 00000101
ls r2, #5               // r2 = 00100000 = 32  (branch back to L1 if idx < 32)
ldr r0, r3              // r0 = 01010000 = data_mem[32]
ldi r3, #3              // r3 = 00000011
ls r3, #6               // r3 = 11000000
addi r3, #3             // r3 = 11000011 = 195  (addr of stored index)
ldr r1, r3              // r1 = 0 data_mem[195]   (current index)
neq r1, r2              // r1 = 1 = (r1 != r2) = (0 != 32)   (true until current index reaches 32
ldi r3, #7              // branch by offset at LUT[7] = -343
bnzl r3, r1             // r1 == 1 => branch to L1!     (in general, go to L1 while r1, the current index, is not equal to 32, continue, until program is finished [end]